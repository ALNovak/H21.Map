    ...
    loadAPI(): Observable<boolean> {
        try {
            return new Observable((observer: Observer<boolean>) => {
                ...
                apiUrl = `${this.apiConfig.url}?v=${this.apiConfig.version}&ak=${this.apiConfig.key}&language=${this.apiConfig.language}&callback=${this.apiConfig.callback}`
                ...
                if (apiScript.readyState) {
                    ...
                    window[this.apiConfig.callback] = () => {
                        setTimeout(() => {
